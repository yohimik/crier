...
| `publish.telegram.lead-video`<br>`CRIER_PUBLISH_TELEGRAM_LEAD_VIDEO`<br>`--publish-telegram-lead-video` | string, path | — | video file posted as the first item of the telegram post, ahead of the pages; it counts towards the attachment limit |
